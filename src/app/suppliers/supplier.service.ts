...
export class SupplierService {
  ...
  //Process first observable and than after finis first start with processing others...
  ...
  //All observables process in paralelal
  ...
  constructor(private http: HttpClient) {
    ...
    // Example for higher prio observable(maps)
